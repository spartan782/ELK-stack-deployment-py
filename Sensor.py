...
def get_args():
	...
	es_parser.add_argument('--elasticsearch-node-name', metavar='NAME', type=str, help='Sets current elasticsearch\'s node name', required=False, default=None)
	...
	es_parser.add_argument('--elasticsearch-heap', metavar='NUM', type=int, help='Sets the amount of RAM elasticsearch is able to use for indexing functions. Recommend 50 percent of availble ram, but no more than 32G', required=False)
	...
	es_parser.add_argument('--elasticsearch-master-discovery', metavar='"NODE, NODE2, ECT"', type=str, help='List of master nodes that can be discovered when this node starts ("192.168.1.11, 192.168.1.12, ect..")',required=False, default=None)
	...
	kafka_parser.add_argument('--kafka-topic', metavar='TOPIC(s)',nargs='+', type=list, help='Topic ID(s) kafka should use and cluster with', required=False, default=["bro_raw", "suricata_raw"])
	...
	logstash_parser.add_argument('--logstash-bro-kafka', metavar='TOPIC' type=str, help='This will setup logstash to move bro logs into a kafka TOPIC ', required=False, default=None)
	logstash_parser.add_argument('--logstash-suricata-kafka', metavar='TOPIC' type=str, help='This will setup logstash to move the eve.json file into a kafka TOPIC', required=False, default=None)
